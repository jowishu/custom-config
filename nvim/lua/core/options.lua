...
vim.o.ignorecase = false -- Case-insensitive searching UNLESS \C or capital in search (default: false)
vim.o.smartcase = false -- Smart case (default: false)
...
vim.o.whichwrap = "bs" -- Which "horizontal" keys are allowed to travel to prev/next line (default: 'b,s')
...
vim.o.pumheight = 20 -- Pop up menu height (default: 0)
...
vim.o.textwidth = 0
vim.opt.formatoptions = "tcqj" -- Don't insert the current comment leader automatically for auto-wrapping comments using 'textwidth', hitting <Enter> in insert mode, or hitting 'o' or 'O' in normal mode. (default: 'croql')
vim.opt.runtimepath:remove("/usr/share/vim/vimfiles") -- Separate Vim plugins from Neovim in case Vim still in use (default: includes this path if Vim is installed)
vim.opt.spell = true -- enable spell check
vim.opt.spelllang = {'en_us'}
vim.g.load_doxygen_syntax = 1 -- doxygen style comment highlight
vim.o.modelines = 1
